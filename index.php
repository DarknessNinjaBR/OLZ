...
$sql1 = "SELECT id_anuncio, nm_titulo, ds_descricao, vl_preco, ds_imagem, id_usuario FROM anuncio ORDER BY id_anuncio DESC LIMIT 6";

$resultado = mysqli_query($connect, $sql1);

$sql2 = "SELECT count(*) FROM anuncio";
...
$sql3 = "SELECT id_anuncio, nm_titulo, ds_descricao, vl_preco, ds_imagem, id_usuario FROM anuncio LIMIT $registroPorPagina OFFSET $inicioPag";
...
<body>
    ...
    <div id="menu">
        ...
        ?>
            ...
            <a style="padding-left: 50%;">Logado como: <?php echo($_SESSION["user"]); ?></a>
    ...
    <div id="conteudo">
        ...
        <table style="border: 0px;">
            ...
            ?>
					<td style="padding: 50px; max-width: 200px;">
                    <a href="anuncio.php?publicacao=<?php echo $anuncio['id_anuncio']; ?>"><img src="assets/imgAnuncio/<?php echo $anuncio['ds_imagem']; ?>" width="100"><br><?php echo $anuncio['nm_titulo']; ?><br>
            ...
            <?php
            while ($anuncio = mysqli_fetch_array($resultado3)) {
            ?>
            <br>
